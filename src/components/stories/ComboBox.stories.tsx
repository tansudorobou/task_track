...
export const Example = (args: Meta<typeof ComboBox>) => (
  <ComboBox {...args}>
...
export const DisabledItems = (args: Meta<typeof ComboBox>) => (
  <Example {...args} />
)
DisabledItems.args = {
  disabledKeys: ["mint"],
...
export const Sections = (args: Meta<typeof ComboBox>) => (
  <ComboBox {...args}>
...
export const Validation = (args: Meta<typeof ComboBox>) => (
