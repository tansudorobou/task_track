...
export const Example = (args: Meta<typeof Select>) => (
  <Select {...args}>
...
export const DisabledItems = (args: Meta<typeof Select>) => (
  <Example {...args} />
)
DisabledItems.args = {
  disabledKeys: ["mint"],
...
export const Sections = (args: Meta<typeof Select>) => (
  <Select {...args}>
...
export const Validation = (args: Meta<typeof Select>) => (
