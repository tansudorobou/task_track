...
export const Example = (args: Meta<typeof Menu>) => (
  <MenuTrigger>
...
export const DisabledItems = (args: Meta<typeof Menu>) => <Example {...args} />
DisabledItems.args = {
  disabledKeys: ["save"],
}

export const Sections = (args: Meta<typeof Menu>) => (
  <MenuTrigger>
    <Button variant="secondary" className="px-2">
      <MoreHorizontal className="w-5 h-5" />
    </Button>
...
export const Submenu = (args: Meta<typeof Menu>) => (
  <MenuTrigger>
    <Button variant="secondary" className="px-2">
      <MoreHorizontal className="w-5 h-5" />
    </Button>
